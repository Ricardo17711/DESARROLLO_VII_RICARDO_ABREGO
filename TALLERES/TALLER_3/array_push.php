...
$misAmigos = ["Jóse", "CC", "Mamon."]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Wacho", "Rolando."); // Reemplaza las comillas vacías con los nombres de tus amigos
