...
$miArray = ["uva", "manzana", "pera"]; // Reemplaza esto con tu propio array
$miString = "Las frutas son saludables e importantes para el humano."; // Reemplaza esto con tu propio string
$miNumero = 17; // Reemplaza esto con tu propio número
